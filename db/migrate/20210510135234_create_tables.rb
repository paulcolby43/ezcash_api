class CreateTables < ActiveRecord::Migration[6.0]
  def change
    create_table "ACHLog", primary_key: "ID", id: :integer, if_not_exists: true do |t|
    ...
    create_table "ACHReversals", id: false, if_not_exists: true do |t|
      t.integer "ACHReportID", null: false
      t.integer "ActID", null: false
    end

    create_table "AccountTypes", primary_key: "AccountTypeID", id: :integer, if_not_exists: true do |t|
    ...
    create_table "Accounts", primary_key: "ActID", id: :integer, if_not_exists: true do |t|
    ...
    create_table "AuthBinRange", primary_key: ["BinLow", "BinHigh"], if_not_exists: true do |t|
    ...
    create_table "Authorizers", primary_key: "AuthID", id: :varchar, limit: 10, default: nil, if_not_exists: true do |t|
    ...
    create_table "CameraTypes", id: false, if_not_exists: true do |t|
      t.integer "CameraType", null: false
      t.varchar "Description", limit: 50
    end

    create_table "Companies", primary_key: "CompanyNumber", id: :integer, if_not_exists: true do |t|
    ...
    create_table "CompanyAccounts", primary_key: ["CompanyNbr", "PriTranCode", "SecTranCode"], if_not_exists: true do |t|
    ...
    create_table "CompanyActDefaultMinBal", id: false, if_not_exists: true do |t|
      t.integer "CompanyNumber"
      t.integer "AccountTypeID"
      t.money "DefaultMinBal", precision: 19, scale: 4
    end

    create_table "CurrencySpecs", id: false, if_not_exists: true do |t|
    ...
    create_table "Customer", primary_key: "CustomerID", id: :integer, if_not_exists: true do |t|
    ...
    create_table "CustomerAccountPermission", primary_key: ["GroupID", "CustomerID"], if_not_exists: true do |t|
    ...
    create_table "CustomerBarcode", primary_key: "RowID", id: :integer, if_not_exists: true do |t|
      t.integer "CustomerID"
    ...
    create_table "CustomerCards", primary_key: "CardID", id: :integer, if_not_exists: true do |t|
      t.integer "CustomerID"
    ...
    create_table "DevTypes", primary_key: "DevType", id: :integer, default: nil, if_not_exists: true do |t|
      t.varchar "description", limit: 80
    end

    create_table "EZPermissionDesc", primary_key: "PermissionID", id: :integer, default: nil, if_not_exists: true do |t|
      t.varchar "Description", limit: 50
    end

    create_table "Entities", primary_key: "EntityID", id: :integer, if_not_exists: true do |t|
    ...
    create_table "EntityAccountTypes", primary_key: ["EntityID", "AccountTypeID"], if_not_exists: true do |t|
    ...
    create_table "FeeDefs", primary_key: "FeeID", id: :integer, if_not_exists: true do |t|
    ...
    create_table "FieldDescriptions", primary_key: "ID", id: :integer, if_not_exists: true do |t|
      t.varchar "TableName", limit: 50
      t.varchar "FieldName", limit: 50
      t.varchar "FieldDescription", limit: 500
    end

    create_table "Fields", primary_key: ["ScreenID", "FieldID"], if_not_exists: true do |t|
    ...
    create_table "Groups", primary_key: "GroupID", id: :integer, if_not_exists: true do |t|
    ...
    create_table "Interfaces", primary_key: "InterfaceID", id: :varchar, limit: 10, default: nil, if_not_exists: true do |t|
      t.varchar "Description", limit: 100
      t.varchar "HostName", limit: 50
      t.integer "PortNbr"
      t.char "HeaderType", limit: 1
    ...
    create_table "LimitBuckets", primary_key: ["LimitID", "BucketOrder"], if_not_exists: true do |t|
    ...
    create_table "Limits", primary_key: "ID", id: :integer, if_not_exists: true do |t|
    ...
    create_table "OpCodesMap", primary_key: "KeySeq", id: :varchar, limit: 20, default: nil, if_not_exists: true do |t|
    ...
    create_table "RoleDescription", primary_key: "RoleID", id: :integer, default: nil, if_not_exists: true do |t|
      t.varchar "RoleDescription", limit: 50, null: false
    end

    create_table "RolePermissions", primary_key: ["RoleID", "PermissionID"], if_not_exists: true do |t|
      t.integer "RoleID", null: false
      t.integer "PermissionID", null: false
      t.integer "Enabled"
    end

    create_table "SMSLog", id: false, if_not_exists: true do |t|
    ...
    create_table "SystemSettings", primary_key: "Setting", id: :varchar, limit: 50, default: nil, if_not_exists: true do |t|
      t.varchar "Value", limit: 100, null: false
      t.varchar "Description", limit: 200
    end

    create_table "TUDUserAuth", id: false, if_not_exists: true do |t|
      t.varchar "UserName", limit: 50, null: false
      t.varchar "UserHash", limit: 50, null: false
    end

    create_table "TransactionTypes", primary_key: "TransactionTypeID", id: :integer, if_not_exists: true do |t|
    ...
    create_table "Workstation_Device", primary_key: "WorkstationID", id: :integer, default: nil, if_not_exists: true do |t|
      t.integer "PinPadID"
      t.integer "ATMDevID"
      t.integer "CompanyNbr"
    ...
    create_table "accounts_events", primary_key: ["account_id", "event_id"], if_not_exists: true do |t|
      t.integer "account_id", null: false
      t.integer "event_id", null: false
      t.index ["account_id", "event_id"], name: "NonClusteredIndex-20190218-115935", unique: true
    end

    create_table "auth_params", id: false, if_not_exists: true do |t|
    ...
    create_table "bill_counts", id: false, if_not_exists: true do |t|
    ...
    create_table "bill_hist", id: false, if_not_exists: true do |t|
      t.datetime "cut_dt"
      t.integer "old_start"
    ...
    create_table "card_field_desc", primary_key: "field_name", id: :varchar, limit: 30, default: nil, if_not_exists: true do |t|
      t.varchar "short_desc", limit: 15
    end

    create_table "cards", primary_key: "card_seq", id: :integer, if_not_exists: true do |t|
    ...
    create_table "change_log", id: false, if_not_exists: true do |t|
      t.varchar "user_name", limit: 40
    ...
    create_table "denoms", primary_key: ["dev_id", "cassette_id"], if_not_exists: true do |t|
      t.float "denomination"
      t.integer "dev_id", null: false
      t.integer "cassette_nbr"
    ...
    create_table "dev_statuses", id: false, if_not_exists: true do |t|
      t.integer "dev_id"
      t.datetime "date_time"
    ...
    create_table "devices", primary_key: "dev_id", id: :integer, default: nil, if_not_exists: true do |t|
      t.integer "online"
    ...
    create_table "error_desc", primary_key: "error_code", id: :integer, default: nil, if_not_exists: true do |t|
      t.varchar "short_desc", limit: 80
      t.varchar "long_desc", limit: 500
    end

    create_table "events", id: :integer, if_not_exists: true do |t|
    ...
    create_table "password_rules", id: false, if_not_exists: true do |t|
      t.integer "pwd_expires_days"
    end

    create_table "status_desc", primary_key: "status", id: :char, limit: 4, default: nil, if_not_exists: true do |t|
      t.varchar "short_desc", limit: 80
      t.integer "caution_flag"
      t.integer "alert_flag"
    end

    create_table "tran_field_desc", primary_key: "field_name", id: :varchar, limit: 30, default: nil, if_not_exists: true do |t|
      t.varchar "short_desc", limit: 15
      t.integer "only_cust_tran", limit: 1
    end

    create_table "tran_status_desc", primary_key: "tran_status", id: :integer, default: nil, if_not_exists: true do |t|
      t.varchar "short_desc", limit: 80
      t.varchar "long_desc", limit: 255
      t.nchar "icon", limit: 500
    end
    
    if ActiveRecord::Base.connection.tables.include?("transactions") && !Transaction.column_names.include?("OrigTranID")
      add_column :transactions, "OrigTranID", :integer
    end

    create_table "transactions", primary_key: "tranID", id: :integer, if_not_exists: true do |t|
    ...
    create_table "user_roles", primary_key: "user_name", id: :varchar, limit: 40, default: nil, if_not_exists: true do |t|
